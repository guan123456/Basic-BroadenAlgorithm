...
/**
* @author 作者:guan
* @createDate 创建时间：Mar 25, 2021 12:10:08 PM
*/
public class NQueens {
	...
	public static void main(String[] args) {
		...
		System.out.println("process2 costs time: " + (end - start) + "ms");
		
		start = System.currentTimeMillis();
		System.out.println(num1(n));
		end = System.currentTimeMillis();
		System.out.println("process1 costs time: " + (end - start) + "ms");
	}
	...
	public static int num1(int n) {
		...
		return process1(0,record,n);// record[i] -> i行的皇后，放在了第几列
	}
